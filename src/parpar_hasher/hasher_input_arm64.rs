...
//
// Fused per-file HasherInput driver for aarch64 — block-MD5 + file-MD5 + block-CRC32.
//
// ARM64 equivalent of hasher_input.rs, using:
//   * md5x2_scalar for both MD5 lanes (portable, always-available)
//   * crc32fast Hasher for streaming CRC32 (software fallback until ARMCRC/PMULL)
//
...
//
// Future: Replace crc32fast with ARMCRC hardware CRC / NEON+PMULL backend.
