...
pub mod hasher_input_dyn; // Architecture-agnostic dispatcher
#[path = "hasher_input_arm64.rs"]
pub mod hasher_input_portable; // Software fallback: scalar MD5x2 + crc32fast
...
// ============================================================================
// Scalar baseline: portable across all architectures
// ============================================================================

pub mod md5x2_scalar;

// ============================================================================
// aarch64 backends: NEON+PMULL, ARM CRC
// ============================================================================
...
#[cfg(target_arch = "aarch64")]
pub use hasher_input_portable::BlockHash;
