...
pub enum CreateError {
    ...
    /// Invalid source block count
    #[error("Invalid block count: {0}")]
    InvalidBlockCount(String),

    /// Invalid recovery block count
    #[error("Invalid recovery block count: {0}")]
    InvalidRecoveryBlockCount(String),

    /// Invalid recovery file count
    #[error("Invalid recovery file count: {0}")]
    InvalidRecoveryFileCount(String),

    /// Invalid first recovery block number
    #[error("Invalid first recovery block: {0}")]
    InvalidFirstRecoveryBlock(String),
