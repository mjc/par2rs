...
pub use xor_jit::{
    ...
    process_slices_multiply_add_xor_jit_x4_inputs_x4_outputs, xor_prepared_bitplane_chunks,
    xor_prepared_bitplane_multi_chunks, BitplaneAddPrefetchKind, XorJitBitplaneKernel,
