...
impl std::fmt::Display for RsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            RsError::TooManyInputBlocks => write!(f, "Too many input blocks for Reed Solomon matrix"),
       ...
       From<u16> + Into<u16>,
{
    ...
    pub fn set_output_range(&mut self, present: bool, low_exponent: u16, high_exponent: u16) -> RsResult<()> {
    ...
    pub fn process(&self, input_index: u32, input_data: &[u8], output_index: u32, output_data: &mut [u8]) -> RsResult<()> {
