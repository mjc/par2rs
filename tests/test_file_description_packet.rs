...
fn test_file_description_packet_fields() {
    ...
    assert_eq!(
        expected_md5_hash,
        [
           0x25, 0x62, 0xcb, 0xea, 0x92, 0x74, 0x14, 0xec, 0xba, 0xce, 0x1d, 0x91, 0x3b, 0x18, 0xde, 0xcf
        ],
    ...
    assert_eq!(
        expected_md5_16k,
        [
            0x56, 0x2F, 0xAF, 0x48, 0x65, 0xD2, 0x28, 0x5D, 0x2F, 0xA8, 0x81, 0x34, 0xED, 0x5B, 0xDF, 0x3D
        ],
