...
fn test_main_packet_fields() {
    ...
    assert_eq!(
        buffer,
        [0x64, 0x32, 0x80, 0xa0, 0x12, 0xea, 0xe7, 0xfe, 0xfb, 0xa0, 0x54, 0x72, 0x61, 0xdf, 0xcd, 0xf3],
        "Set ID mismatch"
    );
    ...
    assert_eq!(
        buffer,
        [0x50, 0x41, 0x52, 0x20, 0x32, 0x2e, 0x30, 0x00, 0x4D, 0x61, 0x69, 0x6e, 0x00, 0x00, 0x00, 0x00],
    ...
    assert_eq!(
        file_ids,
        [
            [0x87, 0x42, 0x70, 0xa6, 0x34, 0xd2, 0x77, 0xf8, 0x8c, 0x0e, 0x0b, 0x25, 0x85, 0x17, 0xc2, 0x63]
        ],
        "File IDs mismatch"
    );
    ...
    assert_eq!(main_packet.file_count, expected_file_count, "File count mismatch");
